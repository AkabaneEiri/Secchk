...
$(document).ready(function() {
	for (var i = 0; i < document.getElementsByName("actCheck").length; ++i) {
				...
				<tr>
					<td style="padding-bottom: 10px; text-align: left;">
						...
						<c:choose>
							...
							<c:otherwise>
								<c:choose>
									<c:when test="${fn:trim(taskData.ctlg_itm_yn_1) != 'C' }">
				...
				<tr>
					<td style="padding-bottom: 10px; text-align: left;">
						...
						<c:choose>
							...
							<c:otherwise>
								<c:choose>
									<c:when test="${fn:trim(taskData.ctlg_itm_yn_2) != 'C' }">
				...
				<tr>
					<td style="padding-bottom: 10px; text-align: left;">
						...
						<c:choose>
							...
							<c:otherwise>	
								<c:choose>
									<c:when test="${fn:trim(taskData.ctlg_itm_yn_3) != 'C' }">
				...
				<tr>
					<td style="padding-bottom: 10px; text-align: left;">
						...
						<c:choose>
							...
							<c:otherwise>	
								<c:choose>
									<c:when test="${fn:trim(taskData.ctlg_itm_yn_4) != 'C' }">
				...
				<tr>
					<td style="padding-bottom: 10px; text-align: left;">
						...
						<c:choose>
							...
							<c:otherwise>	
								<c:choose>
									<c:when test="${fn:trim(taskData.ctlg_itm_yn_5) != 'C' }">
				...
				<tr>
					<td style="padding-bottom: 10px; text-align: left;">
						...
						<c:choose>
							...
							<c:otherwise>	
								<c:choose>
									<c:when test="${fn:trim(taskData.ctlg_itm_yn_6) != 'C' }">
				...
				<tr>
					<td style="padding-bottom: 10px; text-align: left;">
						...
						<c:choose>
							...
							<c:otherwise>	
								<c:choose>
									<c:when test="${fn:trim(taskData.ctlg_itm_yn_7) != 'C' }">
				...
				<tr>
					<td style="padding-bottom: 10px; text-align: left;">
						...
						<c:choose>
							...
							<c:otherwise>	
								<c:choose>
									<c:when test="${fn:trim(taskData.ctlg_itm_yn_8) != 'C' }">
				...
				<tr>
					<td style="padding-bottom: 10px; text-align: left;">
						...
						<c:choose>
							...
							<c:otherwise>	
								<c:choose>
									<c:when test="${fn:trim(taskData.ctlg_itm_yn_9) != 'C' }">
				...
				<tr>
					<td style="padding-bottom: 10px; text-align: left;">
						...
						<c:choose>
							...
							<c:otherwise>	
								<c:choose>
									<c:when test="${fn:trim(taskData.ctlg_itm_yn_10) != 'C' }">
