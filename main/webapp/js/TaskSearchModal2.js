...
function TaskSelect(){
	...
	var Name = iframeEle.contentWindow.document.getElementById("result_nm").value;
	var Code = iframeEle.contentWindow.document.getElementById("result_cd").value;
